...
import { OnusCore, getLocation } from '@onus-elements/core';
...
var OnusElementsProvider = /*#__PURE__*/ function(Component) {
    ...
    function OnusElementsProvider(props) {
        ...
        _this.onusCore = props.core || new OnusCore();
        return _this;
    }
...
var GetElement = function(param) {
    ...
    var subscribe = useContext(Context).subscribe;
    var _useState = _slicedToArray(useState([]), 2), content = _useState[0], setContent = _useState[1];
    if (!subscribe) {
...
var SetElement = function(param) {
    ...
    var _useContext = useContext(Context), register = _useContext.register, unregister = _useContext.unregister;
...
export { GetElement, OnusElementsProvider, SetElement, useSetElement };
